...
declare namespace ts {
    ...
    namespace Debug {
        ...
        let enableDeprecationWarnings: boolean;
...
declare namespace ts {
    ...
    export const dumpTracingLegend: typeof tracingEnabled.dumpLegend;
...
declare namespace ts {
    ...
    export type VisitEachChildNodes = HasChildren | Identifier;
    ...
    export type HasIllegalModifiers = ClassStaticBlockDeclaration | PropertyAssignment | ShorthandPropertyAssignment | MissingDeclaration | FunctionTypeNode | NamespaceExportDeclaration;
    ...
    export interface Identifier extends PrimaryExpression, Declaration {
        ...
        readonly autoGeneratePrefix?: string | GeneratedNamePart;
        readonly autoGenerateSuffix?: string;
    ...
    export interface StringLiteral extends LiteralExpression, Declaration {
        ...
        readonly textSourceNode?: Identifier | StringLiteralLike | NumericLiteral | PrivateIdentifier;
    ...
    export interface SourceFile extends Declaration {
        ...
        resolvedTypeReferenceDirectiveNames: ModeAwareCache<ResolvedTypeReferenceDirective | undefined>;
    ...
    export interface Program extends ScriptReferenceHost {
        ...
        useCaseSensitiveFileNames(): boolean;
        getResolvedModuleWithFailedLookupLocationsFromCache(moduleName: string, containingFile: string, mode?: ModuleKind.CommonJS | ModuleKind.ESNext): ResolvedModuleWithFailedLookupLocations | undefined;
    ...
    export interface TypeChecker {
        ...
        indexInfoToIndexSignatureDeclaration(indexInfo: IndexInfo, enclosingDeclaration: Node | undefined, flags: NodeBuilderFlags | undefined, tracker?: SymbolTracker): IndexSignatureDeclaration | undefined;
        /** Note that the resulting nodes cannot be checked. */
    ...
    export interface SymbolLinks {
        ...
        filteredIndexSymbolCache?: ESMap<string, Symbol>;
    }
    ...
    export interface NodeFactory {
        ...
        createIndexSignature(modifiers: readonly Modifier[] | undefined, parameters: readonly ParameterDeclaration[], type: TypeNode | undefined): IndexSignatureDeclaration;
...
declare namespace ts {
    const Diagnostics: {
        ...
        _0_resolves_to_a_type_only_declaration_and_must_be_re_exported_using_a_type_only_re_export_when_isolatedModules_is_enabled: DiagnosticMessage;
        ...
        Option_preserveValueImports_can_only_be_used_when_module_is_set_to_es2015_or_later: DiagnosticMessage;
        ...
        Enable_experimental_support_for_TC39_stage_2_draft_decorators: DiagnosticMessage;
...
declare namespace ts {
    ...
    export function getDeclarationModifierFlagsFromSymbol(s: Symbol, isWrite?: boolean): ModifierFlags;
     ...
     */
    export function clearMap<K, T>(map: {
        forEach: ESMap<K, T>["forEach"];
        clear: ESMap<K, T>["clear"];
     ...
     */
    export function mutateMapSkippingNewValues<K, T, U>(map: ESMap<K, T>, newMap: ReadonlyESMap<K, U>, options: MutateMapSkippingNewValuesOptions<K, T, U>): void;
     ...
     * Mutates the map with newMap such that keys in map will be same as newMap.
     */
    export function mutateMap<K, T, U>(map: ESMap<K, T>, newMap: ReadonlyESMap<K, U>, options: MutateMapOptions<K, T, U>): void;
    ...
    export function maybeSetLocalizedDiagnosticMessages(getMessages: undefined | (() => typeof localizedDiagnosticMessages)): void;
    ...
    export function getESModuleInterop(compilerOptions: CompilerOptions): boolean | undefined;
    ...
    export function isParameterOrCatchClauseVariable(symbol: Symbol): boolean;
...
declare namespace ts {
    ...
    const isTypeNodeOrTypeParameterDeclaration: (node: Node) => node is TypeParameterDeclaration | TypeNode;
     ...
     */
    function getNodeForGeneratedName(name: GeneratedIdentifier | GeneratedPrivateIdentifier): Node;
    /**
...
declare namespace ts {
     ...
     */
    export function resolvePackageNameToPackageJson(packageName: string, containingDirectory: string, options: CompilerOptions, host: ModuleResolutionHost, cache: ModuleResolutionCache | undefined): PackageJsonInfo | undefined;
    /**
...
declare namespace ts {
    ...
    function visitNodes<T extends Node, U extends T>(nodes: NodeArray<T>, visitor: Visitor, test: (node: Node) => node is U, start?: number, count?: number): NodeArray<U>;
    /**
    ...
    function visitNodes<T extends Node, U extends T>(nodes: NodeArray<T> | undefined, visitor: Visitor, test: (node: Node) => node is U, start?: number, count?: number): NodeArray<U> | undefined;
    /**
     * Visits a NodeArray using the supplied visitor, possibly returning a new NodeArray in its place.
     *
     * @param nodes The NodeArray to visit.
    ...
    function visitArray<T extends Node, U extends T>(nodes: T[] | undefined, visitor: Visitor, test: (node: Node) => node is U, start?: number, count?: number): U[] | undefined;
    function visitArray<T extends Node, U extends T>(nodes: readonly T[] | undefined, visitor: Visitor, test: (node: Node) => node is U, start?: number, count?: number): readonly U[] | undefined;
    function visitArray<T extends Node>(nodes: T[] | undefined, visitor: Visitor, test: (node: Node) => node is T, start?: number, count?: number): T[] | undefined;
    function visitArray<T extends Node>(nodes: readonly T[] | undefined, visitor: Visitor, test: (node: Node) => node is T, start?: number, count?: number): readonly T[] | undefined;
    /**
...
declare namespace ts {
    const enum PrivateIdentifierKind {
        Field = "f",
        Method = "m",
        Accessor = "a"
    }
...
declare namespace ts {
     ...
     */
    export function updateSharedExtendedConfigFileWatcher<T>(projectPath: T, options: CompilerOptions | undefined, extendedConfigFilesMap: ESMap<Path, SharedExtendedConfigFileWatcher<T>>, createExtendedConfigFileWatch: (extendedConfigPath: string, extendedConfigFilePath: Path) => FileWatcher, toPath: (fileName: string) => Path): void;
    /**
     * Remove the project from the extended config file watchers and close not needed watches
     */
    export function clearSharedExtendedConfigFileWatcher<T>(projectPath: T, extendedConfigFilesMap: ESMap<Path, SharedExtendedConfigFileWatcher<T>>): void;
    /**
     * Clean the extendsConfigCache when extended config file has changed
     */
    export function cleanExtendedConfigCache(extendedConfigCache: ESMap<string, ExtendedConfigCacheEntry>, extendedConfigFilePath: Path, toPath: (fileName: string) => Path): void;
    /**
     * Updates watchers based on the package json files used in module resolution
     */
    export function updatePackageJsonWatch(lookups: readonly (readonly [Path, object | boolean])[], packageJsonWatches: ESMap<Path, FileWatcher>, createPackageJsonWatch: (packageJsonPath: Path, data: object | boolean) => FileWatcher): void;
    /**
...
declare namespace ts {
    ...
    export function getErrorSummaryText(errorCount: number, filesInError: readonly (ReportFileInError | undefined)[], newLine: string, host: HasCurrentDirectory): string;
